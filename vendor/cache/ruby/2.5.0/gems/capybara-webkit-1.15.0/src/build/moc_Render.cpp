...
const QMetaObjectExtraData Render::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Render::staticMetaObject = {
    { &SocketCommand::staticMetaObject, qt_meta_stringdata_Render,
      qt_meta_data_Render, &staticMetaObjectExtraData }
};
