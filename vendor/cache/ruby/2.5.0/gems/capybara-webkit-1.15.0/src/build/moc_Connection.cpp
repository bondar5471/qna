...
static const char qt_meta_stringdata_Connection[] = {
    "Connection\0\0command\0commandReady(Command*)\0"
    "response\0finishCommand(Response*)\0"
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->commandReady((*reinterpret_cast< Command*(*)>(_a[1]))); break;
        case 1: _t->finishCommand((*reinterpret_cast< Response*(*)>(_a[1]))); break;
