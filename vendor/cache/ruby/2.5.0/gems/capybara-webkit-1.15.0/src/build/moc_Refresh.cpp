...
static const char qt_meta_stringdata_Refresh[] = {
    "Refresh\0"
};
...
const QMetaObjectExtraData Refresh::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Refresh::staticMetaObject = {
    { &SocketCommand::staticMetaObject, qt_meta_stringdata_Refresh,
      qt_meta_data_Refresh, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Refresh::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Refresh))
        return static_cast<void*>(const_cast< Refresh*>(this));
