...
const QMetaObjectExtraData Header::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Header::staticMetaObject = {
    { &SocketCommand::staticMetaObject, qt_meta_stringdata_Header,
      qt_meta_data_Header, &staticMetaObjectExtraData }
};
